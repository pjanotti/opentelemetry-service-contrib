...
func NewFactory() scraper.Factory {
	return scraper.NewFactory(cpumetadata.Type, createDefaultConfig, scraper.WithMetrics(createMetricsScraper, cpumetadata.MetricsStability))
}

// createDefaultConfig creates the default configuration for the Scraper.
func createDefaultConfig() component.Config {
	return &Config{
		MetricsBuilderConfig: cpumetadata.DefaultMetricsBuilderConfig(),
	}
}
